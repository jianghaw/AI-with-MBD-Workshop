...
[![Open in MATLAB Online](https://www.mathworks.com/images/responsive/global/open-in-matlab-online.svg)](https://matlab.mathworks.com/open/github/v1?repo=jianghaw/AI-with-MBD-Workshop)
...
1. **Design and Train a Neural Network**: Use the **Time Series Modeler** app to interactively train and compare deep learning architectures (MLP, LSTM, GRU, CNN), then integrate the best model into a Simulink simulation.
